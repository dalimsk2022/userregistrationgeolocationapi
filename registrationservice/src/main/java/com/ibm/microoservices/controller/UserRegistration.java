package com.ibm.microoservices.controller;
...
import com.ibm.microoservices.service.Locationservice;
...
public class UserRegistration {
	...
	public UserRegistartionDTO getFooByIdUsingQueryParam(@RequestParam String username,
		...
		try {
			...
			cityname = locService.ValidateCountryAndGetCityUsingIPAddress(ipaddress, "Canada");
